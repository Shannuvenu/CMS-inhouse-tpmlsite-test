...
function clrval() {
    ...
    //if (($('#checkbox21')[0].checked) && (($("#pincode").val().trim()).length == 0)) {
    $('.Inter').hide();
    $('.ROI').hide();
    ...
    function RegionOnPincode() {
        ...
        if (val.length == 0 || isNaN(val)) {
            $("#error").html("<span style='color:white'>Region does not exist, please enter a valid pincode</span>");
        }
        $('.kar,.mandya,.ROI,.Inter').hide();

        $.ajax({
            type: 'POST',
           // url: 'Subscriptions/ChkVal',
            url: 'ChkVal',
            dataType: 'json',
            data: { RegionVal: val },
            //data: { pincode: val },
...
function ShowPrice() {
    ...
    $('.kar,.mandya,.ROI').each(function () { $(this).find('[type=checkbox]').each(function () { this.checked = false; }) })
    $('.Inter').each(function () { $(this).find('[type=Radio]').each(function () { this.checked = false; }) })
...
function DisplayList(arr, dis, ifDiscount, price) {
    ...
    if (ifDiscount === true) {
        ...
        console.log(disp_el);
        disp_el +='<div class="pull-left" ><img src="../../Content/images/subscription-offer.png" class="img-position img-responsive subcrib-img-align subcrib-detail-img" alt="subscription-offer"><div class="subscrib-offer-text1">'+dis;
        
        disp_el += '% off</div></div>';
        
        disp_el += '<div class="clearfix"></div> Total = ' + price + '<div class="clearfix"></div><input name="apply" type="submit" id="btnMailSubmit" value="Pay" class="subcrib-pay" title="" onclick="Save_Val()"></p>';
           }
    else {
        disp_el = disp_el + 'Total =' + price;
        disp_el += '<input name="apply" type="submit" id="btnMailSubmit" value="Pay" class="subcrib-pay" title="" onclick="Save_Val()" >';
    }
...
function val() {
    ...
    fnameDiv = document.getElementById("errorfname");
    lnameDiv = document.getElementById("errorlname");
    emailDiv = document.getElementById("erroremail");
    mobileDiv = document.getElementById("errormobile");
    houseDiv = document.getElementById("errorhouse");
    apartDiv = document.getElementById("errorapart");
    streetDiv = document.getElementById("errorstreet");
    landmarkDiv = document.getElementById("errorlandmark");
    areaDiv = document.getElementById("errorarea");
    postDiv = document.getElementById("errorpost");
    cityDiv = document.getElementById("errorcity");
    pinDiv = document.getElementById("errorpin");
    districtDiv = document.getElementById("errordistrict");
    stateDiv = document.getElementById("errorstate");
    countryDiv = document.getElementById("errorcountry");


    //first name validation
    var fname = document.getElementById("FName");
    if (fname.value == "") {
        fnameDiv.innerHTML = "First name is required";
        fname.focus();
        valid = false;
    ...
    if (lname.value == "") {
        lnameDiv.innerHTML = "Last name is required";
        lname.focus();
        valid = false;
    }
    ...
    if (email.value == "") {
        ...
        if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
            emailDiv.innerHTML = "Not a valid e-mail address!";
            email.focus();
            valid = false;
        }
    ...
    if (mobile.value == "") {
        mobileDiv.innerHTML = "Phone number is required";
        mobile.focus();
        valid = false;
    ...
    if (isNaN(mobile.value)) {
        mobileDiv.innerHTML = "It is not a number";
        mobile.focus();
        valid = false;
    }  

    //house no validation
    var house = document.getElementById("husno");
    if (house.value == "") {
        houseDiv.innerHTML = "House, Flat, Plot Number is required";
    ...
    var apart = document.getElementById("apart");
    if (apart.value == "") {
        apartDiv.innerHTML = "Apartment, Building Name is required";
    ...
    if (street.value == "") {
        streetDiv.innerHTML = "Street Number, Name is required";
    ...
    if (landmark.value == "") {
        landmarkDiv.innerHTML = "Landmark name is required";
    ...
    if (area.value == "") {
        areaDiv.innerHTML = "Area is required";
    ...
    if (post.value == "") {
        postDiv.innerHTML = "Post office is required";
    ...
    if (city.value == "") {
        cityDiv.innerHTML = "City or town is required";
    ...
    if (pin.value == "") {
        pinDiv.innerHTML = "City or town is required";
        pin.focus();
        valid = false;
    ...
    if (district.value == "") {
        districtDiv.innerHTML = "District is required";
        district.focus();
        valid = false;
    ...
    if (state.value == "") {
        stateDiv.innerHTML = "State is required";
        state.focus();
        valid = false;
    ...
    //if (country.value == "") {
    //    countryDiv.innerHTML = "Country is required";
    //    country.focus();
    //    valid = false;
    ...
    //if (date.value == "") {
    //    dateDiv.innerHTML = "Preferred date is required";
    //    date.select();
    //    date.focus();
    //    return false
    //}
    ...
    //        dateDiv.innerHTML = "Please enter a future date";
    //        date.select();
    //        date.focus();
    //        return false;
    //    }
    //}
    //else {
    //    dateDiv.innerHTML = "Invalid date!";
    //    date.select();
    //    date.focus();
    //    return false;
    //}
    ...
    //document.getElementById("errorfname").onkeyup = removeWarning;
    //document.getElementById("errorLname").onkeyup = removeWarning;
    //document.getElementById("erroremail").onkeyup = removeWarning;
